...
namespace bhl
{
    ...
    public:
      class iterator
      {
        ...
        public:
          ...
          iterator& operator--() { _p--; return(*this); }
          iterator operator--(int) { iterator it = *this; _p--; return(it); }
          iterator& operator+=(const int i) { _p += i; return(*this); }
          iterator& operator-=(const int i) { _p -= i; return(*this); }
      ...
      class const_iterator
      {
        ...
        public:
          ...
          const_iterator& operator--() { _p--; return(*this); }
          const_iterator operator--(int) { const_iterator it = *this; _p--; return(it); }
          const_iterator& operator+=(const int i) { _p += i; return(*this); }
          const_iterator& operator-=(const int i) { _p -= i; return(*this); }
  ...
  {
    for(typename Array<T>::const_iterator it = rhs.begin(); it != rhs.end(); it++)
    {
      os << *it << ", ";
    }
